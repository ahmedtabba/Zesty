...
// Type: SevenSpikes.Nop.Plugins.AnywhereSliders.Areas.Admin.Helpers.ISlidePictureHelper
...
public interface ISlidePictureHelper
{
  Task<Dictionary<string, string>> GetPictureDimensionsAsync(int pictureId);

  Task DeleteSlidePicturesAsync(Slide slide);
}
