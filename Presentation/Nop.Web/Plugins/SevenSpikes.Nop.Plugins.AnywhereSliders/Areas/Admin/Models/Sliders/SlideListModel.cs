...
// Type: SevenSpikes.Nop.Plugins.AnywhereSliders.Areas.Admin.Models.Sliders.SlideListModel
...
public record SlideListModel() : BasePagedListModel<
#nullable disable
SlideModel>
{
  [CompilerGenerated]
  ...
  string ToString()
  {
    ...
    stringBuilder.Append(nameof (SlideListModel));
  ...
  [CompilerGenerated]
  public virtual bool Equals(SlideListModel? other)
  {
    return (object) this == (object) other || base.Equals((BasePagedListModel<SlideModel>) other);
  }
}
